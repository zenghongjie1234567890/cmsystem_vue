...
<div id='id'>
    <div style="width: 100%; height: 50px;background-color: #07419e;position: relative;top: -20px;">
        <div style="width: 83%; height: 50px;background-color: #07419e;;margin: auto;">
            <div style="height: 50px;float: left;"><b style="color: #fff;font-size: 23px;line-height: 50px;">竞赛获奖名单文件目录</b></div>
            ...
            <el-col :span="19">
                <div class="grid-content bg-purple-light">
                    <el-table :data="tableData" style="width: 100%;height: 350px;font-size: 16px;">
                        <el-table-column label="获奖名单附件" prop="compName" width="1000px">
                            <template slot-scope="scope">
                                <div style="cursor:pointer;" @click="j(scope.row)">{{scope.row.fileName}}</div>
                            </template>
                        </el-table-column>
                        <el-table-column label="发布时间" prop="fileData" style="margin: auto;">
                        </el-table-column>
                    </el-table>
